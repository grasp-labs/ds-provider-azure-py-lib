...
def test_resource_type_storage_account_value() -> None:
    ...
    """
    assert ResourceType.STORAGE_ACCOUNT == "ds.resource.linked-service.azure-storage-account"
...
def test_resource_type_blob_value() -> None:
    ...
    """
    assert ResourceType.BLOB == "ds.resource.dataset.azure-blob"
...
def test_resource_type_table_value() -> None:
    ...
    """
    assert ResourceType.TABLE == "ds.resource.dataset.azure-table"
